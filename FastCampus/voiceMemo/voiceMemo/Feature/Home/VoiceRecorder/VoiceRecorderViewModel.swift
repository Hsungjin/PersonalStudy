...
// NSObject - AVAudioPlayerDelegate는 NSObject 프로토콜을 채택하여 해당 프로토콜을 기반으로 동작
...
extension VoiceRecorderViewModel {
    ...
    func removeSelectedVoiceRecord() {
        ...
        do {
            ...
            // TODO: - 삭제 실패 오류 얼럿 노출
            displayAlert(message: "선택된 음성메모 파일을 삭제 중 오류가 발생했습니다.")
        }
    }
...
extension VoiceRecorderViewModel {
    ...
    private func startRecording() {
        ...
        do {
            ...
            displayAlert(message: "음성메모 녹음중 오류가 발생했습니다.")
        }
    }
